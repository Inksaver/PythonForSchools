...
def main():
    ...
    print(f"\nYour name (in Caps) is: {getInput('What is your Name?', 2).upper()}\n")
    print(f"\nYour name (in Title Case) is: {getInput('Both names please (in lower case)?', 4).title()}")
    quit()
